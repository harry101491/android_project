...
public class GridTest extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    private Tab[] tabs = {
            ...
            new Tab(R.string.restaurant, R.drawable.restaurants_icon),
            new Tab(R.string.social, R.drawable.social_icon)
    };
        ...
        grid_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View view, int position, long id)
            {
                ...
                if(t.getName() == R.string.map_label)
                {
                    ...
                    mapIntent.putExtra("zipCode", zipcode);
                ...
                else if(t.getName() == R.string.stats)
                {
                    ...
                    statIntent.putExtra("zipCode", zipcode);
                    startActivity(statIntent);
                }
                else if(t.getName() == R.string.restaurant)
                {
                    // handling of the click on the yelp
                    Intent foodIntent = new Intent(getApplicationContext(), FoodListActivity.class);
                    foodIntent.putExtra("zipCode", zipcode);
                    startActivity(foodIntent);
                }
                else if(t.getName() == R.string.social)
                {
                    // handling of the click at home
                    Intent socialIntent = new Intent(getApplicationContext(), SocialListActivity.class);
                    socialIntent.putExtra("zipCode", zipcode);
