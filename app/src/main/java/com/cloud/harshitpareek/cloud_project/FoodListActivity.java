...
public class FoodListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    //private String food_url = "https://kynproj22.appspot.com/restaurants/zip/";
    private String food_url = "http://ec2-34-209-156-29.us-west-2.compute.amazonaws.com:3000/restaurants/zip/";
    private List<Food> food_list;
    private final String TAG = "Inside Food List";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        food_url += String.valueOf(zipcode);
        ...
        try
        {
            ...
            listView.setAdapter(new FoodAdapter(getApplicationContext(), food_list));
    ...
    public Food readMessage(JsonReader reader) throws IOException
    {
        ...
        reader.endObject();
        return new Food(id, name, img_url, site_url, rating, lat, lng, address, phone, zip, city);

    }


    private List<Food> getFoodListFromURL()
    {
        try
        {
